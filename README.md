...
Executable candidate F/G and a candidate general proof, with an explicit polynomial visibility drawing fallback. The full prepared verification passed **112 instances and 209 target outputs**; independent review is pending. No accepted complete rule or manuscript is claimed yet.
...
Verification includes 97 geometric positive targets with two independently found witnesses each, one trivial positive, 14 exactly solved trivial negatives, and 12 additional side-chain decoder checks. The largest actual target has 202,170 points. The negative cases use unit contradictions; nontrivial geometric NO instances remain unverified.
