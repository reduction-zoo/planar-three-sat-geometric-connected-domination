...
Evidence: `uv run python .../work/check.py --self-test` passed on 2026-09-23: corpus gate 112/100/12 and all 112 independent labels. That initial target encoding was tested only on small hand-checkable graphs; later candidate-scale evidence is tracked in `verification.md` and the round records. The finite corpus is diagnostic and cannot prove a reduction.
