...
Next action: test a literal wire mechanism. The direct local interface works on 21 one-variable cases but its clause point cannot join ports spaced more than two units apart. No complete F or G exists.
